...
<body>
	...
	<p>
		<input id="btnReadIndividual" class ="btn btn-primary" type="submit" value="Buscar"> 
	</p>
	
	<div id="ReadIndividual"></div>
	<br>
...
<script type="text/javascript" src="js/scriptReadIndividual.js"></script>
</body>
</html>